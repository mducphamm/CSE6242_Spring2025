...
# Configure Flask app - make sure static_folder points to your React build directory
...
# Serve React App - Root route to serve the main React page
@app.route('/')
def serve():
...
# This is only used when running the app locally, Heroku uses the Procfile
