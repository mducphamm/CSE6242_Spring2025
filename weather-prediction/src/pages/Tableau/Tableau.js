...
const Tableau = () => {
  useEffect(() => {
    ...
    const initTableau = () => {
      if (document.getElementById('viz1742855010180')) {
        const divElement = document.getElementById('viz1742855010180');
      ...
      <div className="tableau-container">
        ...
        <div className="tableau-body">
          <div className="main-visualization">
            <div className="viz-placeholder">
              <div className='tableauPlaceholder'>
                <noscript>
                  <a href='#'>
                    <img src='https://public.tableau.com/static/images/NY/NYCRidershipWeather/MainDash/1_rss.png' style={{border: 'none'}} />
                  </a>
                </noscript>
                <object className='tableauViz' style={{display: 'none'}}>
                  ...
                  <param name='name' value='NYCRidershipWeather/MainDash' />
                  <param name='tabs' value='no' />
                  <param name='toolbar' value='yes' />
                  <param name='static_image' value='https://public.tableau.com/static/images/NY/NYCRidershipWeather/MainDash/1.png' /> 
          ...
          <div className="dashboard-controls">
            ...
            <div className="control-section">
              <div className="control-title">Key Insights</div>
              <ul style={{color: '#aaa', fontSize: '14px', margin: '0', paddingLeft: '20px'}}>
                <li>Temperature influences ridership</li>
                <li>Precipitation decreases usage</li>
                <li>TBD</li>
              </ul>
            </div>
          </div>
